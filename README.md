...
* Multi-line blocks (e.g., AsciiDoc tables) will not work with their default syntax, because single new-lines are wrapped into one line by Pandoc. Thereby please a number sign (`#`) at the end of the line to preserve literal break.
